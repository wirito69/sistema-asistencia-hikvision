...
async function inspectCapabilities() {
  console.log('--- 1. Consultando /ISAPI/Event/notification/httpHosts ---');
  const r1 = await isapiRequest('GET', '/ISAPI/Event/notification/httpHosts');
  console.log('Status:', r1.status);
  console.log('Body:\n', r1.data);

  console.log('\n--- 2. Consultando /ISAPI/Event/notification/httpHosts/capabilities ---');
  const r2 = await isapiRequest('GET', '/ISAPI/Event/notification/httpHosts/capabilities');
  console.log('Status:', r2.status);
  console.log('Body:\n', r2.data);

  console.log('\n--- 3. Consultando /ISAPI/Event/notification/alertStream ---');
  const r3 = await isapiRequest('GET', '/ISAPI/Event/notification/alertStream');
